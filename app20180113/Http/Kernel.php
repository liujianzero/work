...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        ...
        \App\Http\Middleware\LoginOnce::class,
	    \App\Http\Middleware\UserExpires::class,
    ];
    ...
    protected $routeMiddleware = [
        ...
        'order.token' => \App\Http\Middleware\OrderToken::class,
        'agent.admin' => \App\Http\Middleware\AgentAdmin::class,
        'agent.admin.select' => \App\Http\Middleware\AgentAdminSelect::class,
    ];
}

...
class IndexController extends \App\Http\Controllers\IndexController
{
    ...
    public function study(Request $request){
    	...
    	return $this->theme->scope('study.index')->render();
     ...
     *
     */
    public function studyCase1(Request $request){

        $this->initTheme('study');
        $this->theme->setTitle('WebVR造物引擎使用教程');
        return $this->theme->scope('study.case1')->render();
    ...
    public function getVideo(){
        ...
        return $this->theme->scope('study.video')->render();
    }

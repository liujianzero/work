...
class PagesController extends AgentAdminController
{
    ...
    // 博物馆defaults模板-首页
    public function defaults(Route $route, $id)
    {
        ...
        if ($theme['theme'] == $action) {
            ...
            return $this->theme->scope("{$info->module}.{$info->flag}.shop.default_template.index", $view)->render();
        } else {
            abort('404');
        }
    }
    ...
    public function personal(Request $request, $id)
    {
        ...
        if ($theme['theme'] == $str) {
            ...
            return $this->theme->scope("{$info->module}.{$info->flag}.shop.default_template.personal", $view)->render();
        } else {
            abort('404');
        }
    }
    ...
    public function summary(Request $request, $id)
    {
        ...
        if ($theme['theme'] == $str) {
            ...
            return $this->theme->scope("{$info->module}.{$info->flag}.shop.default_template.summary", $view)->render();
        } else {
            abort('404');
        }
    }
    ...
    public function address(Request $request, $id)
    {
        ...
        if ($theme['theme'] == $str) {
            ...
            return $this->theme->scope("{$info->module}.{$info->flag}.shop.default_template.addr", $view)->render();
        } else {
            abort('404');
        }
    }
    ...
    public function order(Request $request, $id)
    {
        ...
        if ($theme['theme'] == $str) {
            ...
            return $this->theme->scope("{$info->module}.{$info->flag}.shop.default_template.order", $view)->render();
        } else {
            abort('404');
        }
    }
    ...
    public function goodsContent(Request $request, $id)
    {
        ...
        if ($theme['theme'] == $str) {
            ...
            return $this->theme->scope("{$info->module}.{$info->flag}.shop.default_template.content", $view)->render();
        } else {
            abort('404');
        }
    }
    ...
    public function select(Request $request)
    {
        ...
        $result = DB::transaction(function () use ($type, $uid) {
            StoreConfig::where('store_id', $uid)->update(['template_id' => $type]);
        });
        $outcome = is_null($result) ? true : false;
        if ($outcome) {
            return response()->json(['code' => '1000', 'msg' => '选择成功']);
        } else {
            return response()->json(['code' => '1004', 'msg' => '选择失败']);
        }
    }

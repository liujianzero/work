                    ...
                    <div class="col-sm-2">
                        <div class="form-group">
                            ...
                            <select id="city" name="city" onchange="checkcity(this)" required class="form-control sect2">
                                <option value="">请选择</option>
                                @foreach($city as $v)
                                    <option value="{{ $v['id'] }}"{{ $info->city == $v['id'] ? ' selected' : '' }}>{{ $v['name'] }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="col-sm-2">
                        <div class="form-group">
                            ...
                            <select id="area" name="area" required class="form-control sect2">
                                <option value="">请选择</option>
                                @foreach($area as $v)
                                    <option value="{{ $v['id'] }}"{{ $info->area == $v['id'] ? ' selected' : '' }}>{{ $v['name'] }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <div class="form-group">
                            ...
                            <textarea id="addresses" name="address" rows="3" required class="form-control" placeholder="例如街道名称，门牌名称，楼层和房间号等信息">{{ $info->address }}</textarea>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="inp1 form-control" id="zip_code" name="zip_code" value="{{ $info->zip_code }}" required placeholder="邮政编码，不清楚请填000000"/>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="inp1 form-control" id="consignee" name="consignee" value="{{ $info->consignee }}" required placeholder="收货人"/>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        <div class="form-group">
                            ...
                            <select id="mobile_prefix_id" name="mobile_prefix_id" required class="form-control sect3">
                                @foreach($prefix as $v)
                                    <option value="{{ $v['id'] }}" @if ($info->mobile_prefix_id == $v['id']) selected @endif>{{ $v['country'] }} +{{ $v['prefix'] }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" id="mobile" name="mobile" value="{{ $info->mobile }}" required class="inp1 form-control" placeholder="手机号码"/>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        <div class="form-group">
                            ...
                            <select id="tel_prefix_id" name="tel_prefix_id" required class="form-control sect3">
                                @foreach($prefix as $v)
                                    <option value="{{ $v['id'] }}" @if ($info->tel_prefix_id == $v['id']) selected @endif>{{ $v['country'] }} +{{ $v['prefix'] }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <div class="input-group" id="tel">
                                <input type="text" name="tel_area_code" value="{{ $info->tel_area_code }}" class="inp1 form-control" placeholder="区号"/>
                                <div class="input-group-addon input-middle">-</div>
                                <input type="text" name="tel" value="{{ $info->tel }}" class="inp1 form-control" placeholder="固定电话"/>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-sm-2 text-right">
                        <div class="checkbox">
                            <label for="is_default">
                                <input id="is_default" name="is_default" type="checkbox" value="Y" @if ($info->is_default == 'Y') checked="checked" @endif/> 默认地址
                            </label>
                        </div>
                    </div>
                </div>

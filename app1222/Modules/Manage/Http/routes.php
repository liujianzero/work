...
Route::group(['prefix' => 'manage', 'middleware' => ['manageauth', 'RolePermission','systemlog']], function() {
    ...
    Route::get('/orderList', 'OrderController@orderList')->name('manage.order');//�����б�
    Route::get('/orderDetail/{id}', 'OrderController@orderDetail')->name('manage.orderDetail');//��������
    Route::post('/orderUpdate', 'OrderController@orderUpdate')->name('manage.orderUpdate');//���¶���
    Route::get('/orderDel/{id}', 'OrderController@orderDel')->name('manage.orderDel');//ɾ������
    ...
    // ��ҵ��֤��������֤��
    Route::get('/organizationAuthList', 'AuthController@organizationAuthList')->name('organizationAuthList');
    Route::get('/organizationAuthHandle/{id}/{action}', 'AuthController@organizationAuthHandle')->name('organizationAuthHandle');
    Route::get('/organizationAuth/{id}', 'AuthController@organizationAuth')->name('organizationAuth');
    ...
    //�������
    Route::get('/agentList','AgentController@agentList')->name('agentList');
    Route::get('/addAgentPage','AgentController@addAgentPage')->name('addAgentPage');
    Route::post('/agentCreate','AgentController@agentCreate')->name('agentCreate');
    Route::get('/agentEditPage/{id}','AgentController@agentEditPage')->name('agentEditPage');
    Route::post('/agentEdit','AgentController@agentEdit')->name('agentEdit');
    Route::get('/agentDetail','AgentController@agentDetail')->name('agentDetail');
    
    //��ѵ��������
    Route::get('/trainList','AgentTrainController@trainList')->name('trainList');
    Route::get('/addTrainPage','AgentTrainController@addTrainPage')->name('addTrainPage');
    Route::post('/trainCreate','AgentTrainController@trainCreate')->name('trainCreate');
    Route::get('/trainEditPage/{id}','AgentTrainController@trainEditPage')->name('trainEditPage');
    Route::Post('/trainEdit','AgentTrainController@trainEdit')->name('trainEdit');
    Route::get('/trainDetail/{id}','AgentTrainController@trainDetail')->name('trainDetail');
    
    //�༶����
    Route::get('/classList','AgentTrainClassController@classList')->name('classList');
    Route::get('/addClassPage','AgentTrainClassController@addClassPage')->name('addClassPage');
    Route::post('/addClass','AgentTrainClassController@addClass')->name('addClass');
    Route::get('/classEditPage/{id}','AgentTrainClassController@classEditPage')->name('classEditPage');
    Route::Post('/classEdit','AgentTrainClassController@classEdit')->name('classEdit');
    Route::get('/classDetail','AgentTrainClassController@classDetail')->name('classDetail');
    
    //ѧԱ����
    Route::get('/trainUserList','AgentTrainUserController@trainUserList')->name('trainUserList');
    Route::get('/addTrainUserPage','AgentTrainUserController@addTrainUserPage')->name('addTrainUserPage');
    Route::post('/addTrainUser','AgentTrainUserController@addTrainUser')->name('addTrainUser');
    Route::get('/editTrainUserPage/{id}','AgentTrainUserController@trainUserEditPage')->name('editTrainUserPage');
    Route::post('/editTrainUser','AgentTrainUserController@editTrainUser')->name('editTrainUser');
    Route::get('/trainUserDetail','AgentTrainUserController@trainUserDetail')->name('trainUserDetail');
    
	//�û��ȼ�
	
    Route::get('/userLevelList','UserLevelController@userLevelList')->name('userLevelList');
    Route::get('/addUserLevelPage','UserLevelController@addUserLevelPage')->name('addUserLevelPage');
    Route::post('/addUserLevel','UserLevelController@addUserLevel')->name('addUserLevel');
	
    Route::get('/userLevelEditPage/{id}','UserLevelController@userLevelEditPage')->name('userLevelEditPage');
    Route::post('/userLevelEdit','UserLevelController@userLevelEdit')->name('userLevelEdit');

    
   //ģ�͹���
   
    Route::get('/modelsList','ModelsController@modelsList')->name('modelsList');  //首页最新作品推�?
    Route::get('/indexModelsList','ModelsController@indexModelsList')->name('indexModelsList');  //首页精品推荐
      
    Route::get('/indexModels/{id}','ModelsController@indexModels')->name('indexModels'); 
    Route::get('/handleModels/{id}/{action}', 'ModelsController@handleModels')->name('handleModels');
    Route::post('/changeModelsSort','ModelsController@changeModelsSort')->name('changeModelsSort');
    
    Route::get('/modelsVrList','ModelsController@modelsVrList')->name('modelsVrList');
    Route::get('/indexModelsVr/{id}','ModelsController@indexModelsVr')->name('indexModelsVr');
    Route::get('/handleModelsVr/{id}/{action}', 'ModelsController@handleModelsVr')->name('handleModelsVr');
    Route::post('/changeVrModelsSort','ModelsController@changeVrModelsSort')->name('changeVrModelsSort');
    
    //会员套餐管理
    Route::get('/addMemberPackegPage','UserMemberController@addMemberPackegPage')->name('addMemberPackegPage');//添加会员套餐
    Route::get('/memberPackegList','UserMemberController@memberPackegList')->name('memberPackegList');//会员套餐列表
    Route::post('/addMemberPackeg','UserMemberController@addMemberPackeg')->name('addMemberPackeg');//添加会员套餐
    Route::get('/userMemberPackegEditPage/{id}','UserMemberController@userMemberPackegEditPage')->name('userMemberPackegEditPage');//添加会员套餐
    Route::post('/userMemberPackegEdit','UserMemberController@userMemberPackegEdit')->name('userMemberPackegEdit');//会员套餐编辑

    //报名信息表管理
    Route::get('/Registration', 'RegistrationFormController@Registration')->name('Registration');

...
class DistrictModel extends Model
{
    ...
    {
        $key = 'region_list_' . $pid;
        if (Cache::has($key)) {
            $data = Cache::get($key);
        } else {
            $data = self::where('upid', $pid)->lists('name', 'id');
    ...
    {
        return $this->hasMany('App\Modules\User\Model\UserAddress', 'province', 'id');
    }
    ...
    {
        return $this->hasMany('App\Modules\User\Model\UserAddress', 'city', 'id');
    }
    ...
    {
        return $this->hasMany('App\Modules\User\Model\UserAddress', 'area', 'id');
    }

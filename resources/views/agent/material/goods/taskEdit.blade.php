        ...
        <form class="form-horizontal" id="validateTaskFrom" enctype="multipart/form-data">
            ...
            <div class="task-group" style="display: block;">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        ...
                        <select class="form-control" id="cate_pid" name="cate_pid" onchange="getCategory(this);">
                            ...
                            @foreach ($cate as $k => $v)
                                <option value="{{ $k }}" @if ($info->cate_pid == $k) selected @endif>{{ $v }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-sm-2">
                        ...
                        <select class="form-control" id="cate_id" name="cate_id">
                            ...
                            @foreach ($cate_children as $k => $v)
                                <option value="{{ $k }}" @if ($info->cate_id == $k) selected @endif>{{ $v }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                    ...
                    <div class="col-sm-6">
                        @foreach ($region_limit as $v)
                            <label class="checkbox-inline">
                                <input type="radio" id="region_limit" name="region_limit" value="{{ $v['val'] }}" @if ($v['val'] == $info->region_limit) checked @endif> {{ $v['name'] }}
                            </label>
                        @endforeach
                    </div>
                </div>
                    ...
                    <div class="col-sm-2">
                        ...
                        <select class="form-control" id="province" name="province" onchange="getCity(this);">
                            ...
                            @foreach ($province as $k => $v)
                                <option value="{{ $k }}" @if ($info->province == $k) selected @endif>{{ $v }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-sm-2">
                        ...
                        <select class="form-control" id="city" name="city" onchange="getArea(this);">
                            <option value="">请选择</option>
                            @foreach ($city as $k => $v)
                                <option value="{{ $k }}" @if ($info->city == $k) selected @endif>{{ $v }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-sm-2">
                        ...
                        <select class="form-control" id="area" name="area">
                            <option value="">请选择</option>
                            @foreach ($area as $k => $v)
                                <option value="{{ $k }}" @if ($info->area == $k) selected @endif>{{ $v }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <textarea class="form-control" id="desc" name="desc">{{ $info->desc }}</textarea>
            ...
            <div class="task-group">
                    ...
                    <div class="col-sm-6">
                        @foreach ($type as $k => $v)
                            <div class="col-sm-4" style="padding-left: 0;">
                                <label class="checkbox-inline">
                                    <input type="radio" id="type_id" data-index="{{ $k }}" name="type_id" value="{{ $v->id }}" @if ($v->id == $info->type_id) checked @endif> {{ $v->name }}
                                </label>
                            </div>
                        @endforeach
                    </div>
                ...
                <div class="action-mode-div" style="display: block;">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <label class="checkbox-inline">
                                <input type="radio" id="bounty_select" name="bounty_select" value="0" @if (! $info->action_id) checked @endif> 直接填写赏金
                            </label>
                            <label class="checkbox-inline">
                                <input type="radio" id="bounty_select" name="bounty_select" value="1" @if ($info->action_id) checked @endif> 选择赏金区间
                            </label>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <div class="tender-bounty">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="tender_bounty" name="tender_bounty" value="{{ $info->bounty }}">
                                </div>
                            </div>
                            <div class="tender-bounty" style="display: none;">
                                ...
                                <select class="form-control" id="tender_bounty_id" name="tender_bounty_id">
                                    ...
                                    @foreach ($price_range as $v)
                                        <option value="{{ $v->id }}" @if ($info->action_id == $v->id) selected @endif>￥{{ $v->min_price }} - {{ $v->max_price or '以上' }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                ...
                <div class="action-mode-div">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-rmb"></i></span>
                                <input type="text" class="form-control" id="single_bounty" name="single_bounty" value="{{ $info->bounty }}" onchange="handlePrice();">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="action-mode-div">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-rmb"></i></span>
                                <input type="text" class="form-control" id="multiple_bounty" name="multiple_bounty" value="{{ $info->bounty }}" onchange="setMultipleWorker(this);">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="multiple_worker_num" name="multiple_worker_num" value="{{ $info->worker_num }}" onchange="setMultipleWorker('#multiple_bounty');">
                ...
                <div class="action-mode-div">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-rmb"></i></span>
                                <input type="text" class="form-control" id="job_bounty" name="job_bounty" value="{{ $info->bounty }}" onchange="setJobWorker(this);">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="job_worker_num" name="job_worker_num" value="{{ $info->worker_num }}" onchange="setJobWorker('#job_bounty');">
                            <span class="input-tips"></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <div class="input-daterange input-group datepicker">
                            ...
                            <input type="text" class="form-control text-center" id="delivery_deadline" name="delivery_deadline" value="{{ date('Y-m-d', strtotime($info->delivery_deadline)) }}" placeholder="结束时间" readonly style="background: #fff;cursor: pointer;"/>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    @foreach($service as $k => $v)
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-2 col-md-offset-2 col-md-2 col-lg-offset-4 col-lg-2">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" data-price="{{ $v->price }}" data-index="{{ $k }}" name="product[]" value="{{ $v->id }}" @if (in_array($v->id, $task_service)) checked @endif>
                                        <span class="@if (in_array($v->id, $task_service)){{ $k % 2 ? ' active-odd' : ' active-even' }}@endif">{{ substr($v->title, 3, 3) }}</span>
                                    </label>
                                </div>
                            </div>
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4 col-md-4 col-lg-2">
                        <p class="form-control-static">￥<span id="bounty-money">{{ $info->bounty }}</span></p>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <div class="col-sm-4 col-sm-offset-4 col-md-offset-4 col-md-4 col-lg-offset-4 col-lg-4">
                        <table class="table table-hover">
                            @foreach ($service as $k => $v)
                                <tr id="product-{{ $v->id }}" @if (! in_array($v->id, $task_service))style="display: none;"@endif>
                                    <td>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4 col-md-4 col-lg-2">
                        <p class="form-control-static">￥<span id="total-price">{{ $total_price }}</span></p>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-6">
                        <label class="checkbox-inline">
                            <input type="radio" id="status" name="status" value="1" @if ($info->status == 1) checked @endif> 暂不发布
                        </label>
                        <label class="checkbox-inline">
                            <input type="radio" id="status" name="status" value="2" @if ($info->status == 2) checked @endif> 正常发布
                        </label>
                    </div>
                </div>
                <div class="form-group">
